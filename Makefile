...
format-check: pub-get
	@dart format --output=none --set-exit-if-changed lib test example benchmark/lib benchmark/test tool/validate_published_consumer.dart tool/verify_public_storage_contract.dart tool/hive_ce_migration_fixture/test || { status=$$?; echo '--- formatted tool/verify_public_storage_contract.dart ---'; dart format --output=show tool/verify_public_storage_contract.dart; exit $$status; }
